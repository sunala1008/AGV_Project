...
namespace AGV.Control
{
    public partial class RegistControl : UserControl
    {
        ...
        private void BtnMapLoad_Click(object sender, EventArgs e)
        {
            ...
            dialog.InitialDirectory = @"D:\MAP"; // 초기 폴더
        ...
        private Connect_ClickEventArgs OnConnect_Click(Socket sock, MJPEGStream stream, string mapAddress)
        {
            Connect_ClickEventArgs args = new Connect_ClickEventArgs(sock, stream, mapAddress);
        ...
        public class Connect_ClickEventArgs : EventArgs
        {
            ...
            public Connect_ClickEventArgs(Socket sock, MJPEGStream stream, string mapAddress)
            {
                Sock = sock;
                Stream = stream;
